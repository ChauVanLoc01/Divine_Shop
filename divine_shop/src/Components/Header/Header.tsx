    ...
    <div className='text-white'>
      <div className='bg-[#0A59CC] py-2 lg:block hidden'>
        <div className='flex xl:max-w-7xl lg:max-w-4xl lg:mx-auto lg:text-base'>
          ...
          <div className='flex justify-end basis-2/3 space-x-6'>
      ...
      <div className='bg-[#2579F2]'>
        <div className='xl:max-w-7xl lg:max-w-4xl lg:mx-auto lg:px-0 px-2 md:px-4 md:text-base text-sm py-3 space-y-4'>
          <div className='flex justify-between'>
            ...
            <form className='flex md:w-[35%] w-[55%]'>
            ...
            <button className='flex items-center space-x-2 p-2 border-[1px] hover:bg-[#2985FF] transition-all duration-200 border-white rounded-md'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
          ...
          <div className='lg:flex hidden justify-between'>
            <div className='space-x-2 flex items-center hover:underline hover:cursor-pointer'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                fill='none'
                viewBox='0 0 24 24'
