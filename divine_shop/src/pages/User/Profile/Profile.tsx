  ...
  return (
    <div className='rounded-lg bg-white border border-gray-100 p-1'>
      <form className='flex md:space-y-0 space-y-5 md:flex-row flex-col lg:px-10 md:px-5 lg:py-5 md:py-3 p-3'>
        <div className='basis-3/5 grid grid-cols-2 content-around gap-y-3'>
          ...
          <div className='col-start-2 text-right py-2'>
            <button className='ring-2 ring-gray-400 hover:ring-[#2579F2] rounded-md px-5 py-1 text-[#2579F2] font-semibold'>
              Lưu thay đổi
            </button>
          </div>
        </div>
        <div className='basis-2/5 space-y-4 flex flex-col items-center'>
          <img
            className='bg-cover rounded-full w-2/5'
            src='https://cdn.divineshop.vn/image/catalog/icon/avatar-khach-hang-2-52544.png?hash=1649933269'
            alt='avatar'
          />
          <div>
            <button className='px-3 py-1 rounded-md bg-[#2579F2] text-white hover:bg-[#2579F2]/90 ring-2 ring-[#2579F2]/90 hover:ring-[#2579F2]'>
